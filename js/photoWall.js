...
var imgDataPath = '/photos/photos.json'
// var imgPath = "https://cdn.jsdelivr.net/gh/Cenergy/images/gallery/"; //图片访问路径
// var imgPath ='/photos/images/'
// 注意这里末尾是有分隔符的
var imgPath = "https://gallery.edwardzcn98yx.com/"
var imgSuffix = "/compress1920"
  ...
  constructHtml(options) {
    ...
    const htmlEle = `<div class="card lozad" style="width:${imageWidth}px">
                  <div class="ImageInCard" style="height:${
                    ...
                    <a data-fancybox="gallery" href="${imgPath}${name}/${imgNameWithPattern}${imgSuffix}"
                          data-caption="${imgName}" title="${imgName}">
                            <img  class="lazyload" data-src="${imgPath}${name}/${imgNameWithPattern}${imgSuffix}"
